...
export const Moves: {[moveid: string]: MoveData} = {
	...
	aircutter: {
		...
		pp: 25,
		priority: 0,
		flags: {protect: 1, mirror: 1, slice: 1},
		critRatio: 2,
		secondary: null,
		target: "allAdjacentFoes",
		type: "Flying",
	...
	airslash: {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1, distance: 1, slice: 1},
		secondary: {
			chance: 30,
	...
	precipiceblades: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, nonsky: 1, slice: 1},
		target: "allAdjacentFoes",
		type: "Ground",
		contestType: "Cool",
	},
	...
	solarblade: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, slice: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}

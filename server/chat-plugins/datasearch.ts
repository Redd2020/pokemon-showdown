...
export const commands: Chat.ChatCommands = {
	...
	movesearchhelp() {
		this.sendReply(
			...
			`Valid flags are: authentic (bypasses substitute), bite, bullet, charge, contact, dance, defrost, gravity, mirror (reflected by mirror move), ohko, powder, priority, protect, pulse, punch, kick, recharge, recovery, reflectable, secondary, snatch, sound, zmove, pivot, and multi-hit.<br/>` +
...
function runDexsearch(target: string, cmd: string, canAll: boolean, message: string, isTest: boolean) {
	...
	const allFormes = ['alola', 'galar', 'primal', 'therian', 'totem', 'ethereal', 'akuurian'];
...
function runMovesearch(target: string, cmd: string, canAll: boolean, message: string, isTest: boolean) {
	...
	const allFlags = [
		...
		'multihit', 'ohko', 'powder', 'protect', 'pulse', 'punch', 'kick', 'erupt', 'recharge', 'reflectable', 'secondary',
